...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND  ${PROTOBUF_PROTOC_EXECUTABLE} ARGS --cpp_out  ${CMAKE_CURRENT_BINARY_DIR} ${_protobuf_include_path} ${ABS_FIL}
...
function(_protobuf_find_libraries name filename)
   ...
   find_library(${name}_LIBRARY
       NAMES ${filename}
       PATHS ${PROTOBUF_SRC_ROOT_FOLDER}/lib)
...
find_path(PROTOBUF_INCLUDE_DIR
    google/protobuf/service.h
    PATHS ${PROTOBUF_SRC_ROOT_FOLDER}/include
)
mark_as_advanced(PROTOBUF_INCLUDE_DIR)
...
find_program(PROTOBUF_PROTOC_EXECUTABLE
    ...
    ${PROTOBUF_SRC_ROOT_FOLDER}/${_PROTOBUF_ARCH_DIR}Release
    ${PROTOBUF_SRC_ROOT_FOLDER}/vsprojects/${_PROTOBUF_ARCH_DIR}Debug
)
mark_as_advanced(PROTOBUF_PROTOC_EXECUTABLE)

message(STATUS "PROTOBUF_LIBRARY " ${PROTOBUF_LIBRARY})
message(STATUS "PROTOBUF_PROTOC_LIBRARY " ${PROTOBUF_LIBRARY})
