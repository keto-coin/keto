...
/* 
 * File:   RootCertificate.hpp
 * Author: ubuntu
 *
 * Created on January 22, 2018, 2:57 AM
 */

#ifndef KETO_HTTP_ROOT_CERTIFICATE_HPP
#define KETO_HTTP_ROOT_CERTIFICATE_HPP
...
template<class = void>
void
load_root_certificates(boostSsl::context& ctx, boost::system::error_code& ec)
{
...
inline
void
load_root_certificates(boostSsl::context& ctx)
{
